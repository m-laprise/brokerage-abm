...
This article develops a theory of brokerage as outsourced relational work and explains how the resulting informational advantage can enable a transition from intermediary to principal. An agent-based model formalizes one part of this argument, illustrating how repeated matchmaking can generate informational and structural advantages and producing propositions for future empirical research. The article addresses three questions about brokerage:
...
I develop an agent-based model (ABM) of brokerage in a general matching market to formalize and illustrate how brokers can create and preserve an informational advantage through repeated matchmaking. The simulations show how several simple elements interact to produce non-obvious dynamics, complicating the expectation that brokers densify networks around them and erode their own position. The ABM results suggest that brokerage can provide assessment rather than access, and that clients may continue outsourcing even when they can reach counterparties themselves. An experiment separating the two services shows that assessment contributes more value to principals than access. The broker can provide valuable access to new counterparties when market participants leave and are replaced by new entrants at a high rate, disrupting existing relationships. By introducing previously unconnected principals, it also creates direct ties that can weaken its own structural position. The broker's assessment advantage comes from the information generated through its outsourced relational work. By pooling observations across clients, the broker learns how both parties' characteristics combine. These assessments are more valuable when match quality depends on complementarity, or how well two parties fit together, rather than their general quality. By providing valuable assessments, the broker can sustain demand for its relational work. Because outsourcing connects principals to the broker, sustained use can increase its structural prominence. Centrality, or bridging position, is distinct from bridging behavior: a broker can be highly central while doing little or no bridging. The ABM results illustrate this and recast betweenness centrality not only as a source of brokerage opportunity, but also as a product of the kind and quality of a broker's relational work.
...
The formal illustration that follows isolates one upstream part of the theory: a repeat-player broker observes outcomes across clients and uses the resulting information to organize subsequent matches. It examines how assessment, access, outsourcing, and network position can evolve together. It does not model the corporate form or the subsequent transition to resource capture or data enclosure.
...
The model formalizes the accumulation of informational and structural advantage, but it stops before the transition to capture. I now return to the theoretical argument to explain how a corporate broker may convert those accumulated advantages into ownership or control.
