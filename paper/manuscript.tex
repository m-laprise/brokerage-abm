...
The model that follows illustrates the basis for the theory: a repeat-player broker observes outcomes across clients and uses the resulting information to organize subsequent matches. The model portrays how assessment and access work, outsourcing rates, and network topology can evolve together.
