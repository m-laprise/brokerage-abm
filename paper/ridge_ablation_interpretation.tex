...
\rav{size_matchedBaselineDelta_rank_gap} from paired Ridge (Monte Carlo standard
error \rav{size_matchedBaselineDeltaSE_rank_gap}).  The single-principal and
...
\rav{additiveBaselineDelta_rank_gap}.  Their Monte Carlo standard errors are
\rav{single_principalBaselineDeltaSE_rank_gap} and
\rav{additiveBaselineDeltaSE_rank_gap}.
...
\rav{singleMinusAdditiveBaseline_rank_gap}, with Monte Carlo standard error
\rav{singleMinusAdditiveBaselineSE_rank_gap}.  Across effective realizations,
