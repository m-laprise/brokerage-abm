...
% Built by scripts/paper/build_section.jl on 2026-06-11 18:07
% from section_source.tex + captions.tex + values.tex + figmeta.tex;
% sweep 2026-06-07_f424438; repo commit 763efc3.
...
\begin{figure}[t]
\centering
{\large\bfseries Broker betweenness centrality and access fraction\par}\vspace{2pt}
\includegraphics[width=0.92\linewidth]{figs/fig1_position_work.png}
\caption{Top row: ensemble means over time at the baseline regime pair (no capture, blue;
capture, orange), as 5-observation rolling means; betweenness is
measured every 20 periods. Bottom: late means across the
one-at-a-time no-capture regimes, one dot per regime, colored by the late-mean
output gap (broker minus self). Axes start at $t=30$ (end of
burn-in).}
\label{fig:position}
\end{figure}
...
\begin{figure}[t]
\centering
{\large\bfseries Late-window means vs. effective rank\par}\vspace{2pt}
\includegraphics[width=0.78\linewidth]{figs/fig2_rank_lines.png}
\caption{Four outcomes against the effective rank $r_{90}$ of the matching function;
...
\begin{figure}[t]
\centering
{\large\bfseries Late-window means across the matching-function grid\par}\vspace{2pt}
\includegraphics[width=\linewidth]{figs/fig3_grid_lines.png}
\caption{Nine outcomes across the $\rho\times\delta$ grid, late means (no capture;
...
\begin{figure}[t]
\centering
{\large\bfseries Structural measures vs. informational and output gaps\par}\vspace{2pt}
\includegraphics[width=0.92\linewidth]{figs/fig4_advantage.png}
\caption{Rank-correlation gap (broker minus agent) and output gap (broker minus self)
...
\begin{figure}[t]
\centering
{\large\bfseries Captured demand share across regimes\par}\vspace{2pt}
\includegraphics[width=\linewidth]{figs/fig5_capture.png}
\caption{Captured share of outsourced demand. Top row: late means (line) and $\pm 1$ SD
...
\begin{figure}[t]
\centering
{\large\bfseries Baseline dynamics over time\par}\vspace{2pt}
\includegraphics[width=\linewidth]{figs/fig6_dynamics.png}
\caption{Without capture (top row) and with capture (bottom row): matches per agent,
...
5-observation rolling ensemble means; betweenness is rolled over its
20-period measurements. In each panel, pale gray reproduces the
