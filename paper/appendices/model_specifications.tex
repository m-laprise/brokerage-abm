...
Requested-position outcomes & For each channel, record the share of requested positions filled and realized output net of channel costs per requested position. Unfilled positions contribute zero output. \\
