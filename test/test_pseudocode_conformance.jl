...
# - Satisfaction and reputation: channel-specific EWMA formulas, broker fees,
#   demand-only updates, tried-broker state, and reputation update/hold behavior.
...
#   outsourcing rates, access/roster sizes, and network metrics.
#
