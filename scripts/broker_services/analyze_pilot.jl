...
Usage: julia --project --threads=auto scripts/broker_services/analyze_pilot.jl
"""
...
function load_pilot_results()
    ...
    meta[:scope] == :broker_services || error("unexpected sweep scope")
    ...
    for condition in baseline_conditions
        ...
        for seed in PILOT_SEEDS
            ...
            shard_is_current(shard, provenance) || error("missing current pilot shard: $shard")
