...
Compile the Ridge research notes under `notes/`. LaTeX auxiliary files are
created in temporary directories and discarded.
...
const REPORTS = (
    (
        ...
        output=joinpath(NOTES, "ridge_experiment.pdf"),
        provenance=(
    ...
    (
        ...
        output=joinpath(NOTES, "ridge_ablation_experiment.pdf"),
        provenance=(
            joinpath(
