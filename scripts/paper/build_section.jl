...
for provenance_file in (VALS, CONVERGENCE_VALS, RIDGE_VALS, ABLATION_VALS, FIGMETA)
    occursin(REPORTING_PROVENANCE.commit, read(provenance_file, String)) ||
        fail("$(basename(provenance_file)) was generated by a different analysis commit")
end
...
% sweep $SWEEP; analysis commit $(REPORTING_PROVENANCE.short_commit); clean sources.
