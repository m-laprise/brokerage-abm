...
% Built by scripts/paper/build_manuscript.jl on 2026-09-01T05:09:49.659.
...
and each restriction across the
...
broker-minus-principal difference in holdout rank correlation from 0.28 to -0.04
...
the output gap is broker channel minus self-search.}
\label{fig:grid}
\end{figure}
...
\caption{\textbf{Prediction and output differences vs centrality and access.} Difference in holdout rank correlation (broker minus principal) and output gap (broker channel
...
broker-minus-principal difference in holdout rank correlation from 0.10 to
